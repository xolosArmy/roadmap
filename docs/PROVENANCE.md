...
Historical public-roadmap implementation work was inspected where available. It was not provenance-recovered and was not reused. The current implementation derives from the current canonical roadmap sources and explicit public publication policy.
...
The minimal initial baseline contains only a five-line README. It establishes a PR base; all feature implementation belongs on a dedicated implementation branch. A bootstrap README is not an implementation release.
